    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=30)),
                ('block', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sector', to='index.block')),
            ],
        ),
        migrations.CreateModel(
            name='Village',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=30)),
                ('sector', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='village', to='index.sector')),
            ],
        ),
        migrations.CreateModel(
            name='Taluka',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=30)),
                ('district', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='taluka', to='index.district')),
            ],
        ),
        migrations.CreateModel(
            name='Responses',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('awcs', models.ManyToManyField(related_name='awcs', to='index.awc')),
                ('blocks', models.ManyToManyField(related_name='blocks', to='index.block')),
                ('choices', models.ManyToManyField(related_name='choices', to='index.choices')),
                ('districts', models.ManyToManyField(related_name='districts', to='index.district')),
                ('sectors', models.ManyToManyField(related_name='sectors', to='index.sector')),
                ('villages', models.ManyToManyField(related_name='villages', to='index.village')),
            ],
        ),
        migrations.AddField(
            model_name='form',
        ...
        migrations.AddField(
            model_name='block',
            name='taluka',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='blockes', to='index.taluka'),
        ),
        migrations.AddField(
            model_name='awc',
            name='sector',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='awc', to='index.sector'),
        ),
        migrations.AddField(
            model_name='awc',
            name='village',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='awc', to='index.village'),
        ),
        migrations.AddField(
            model_name='answer',
            name='answer_to',
